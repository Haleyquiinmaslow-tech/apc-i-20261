...
int main() {
    ...
    do{
        ...
        switch(valor) {
            ...
            case 11: printf("Recarga de R$ 20,00 realizada\n"); break;
            case 12: printf("Recarga de R$ 50,00 realizada\n"); break;
            case 0: break;
